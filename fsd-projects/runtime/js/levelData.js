    ...
    var levelData = [
      {
        ...
        gameItems: [
          ...
          { type: "reward", x: 600, y: groundY - 110, hitZoneSize: 25, image: "img/coin.png", offsetX: -29, offsetY: -26, sizeX: 0.25, sizeY: 0.25, speed: 1, healthGained: 10, points: 100},
          { type: "reward", x: 1000, y: groundY - 110, hitZoneSize: 25, image: "img/coin.png", offsetX: -29, offsetY: -26, sizeX: 0.25, sizeY: 0.25, speed: 1, healthGained: 10, points: 100},
          { type: "reward", x: 2500, y: groundY - 110, hitZoneSize: 25, image: "img/coin.png", offsetX: -29, offsetY: -26, sizeX: 0.25, sizeY: 0.25, speed: 1, healthGained: 10, points: 100},
          { type: "level marker", x: 3900, y: groundY - 110},
        ],
      },
      {
        name: "Robot Rampage",
        ...
        gameItems: [
          ...
          { type: "enemy", x: 400, y: groundY - 50, image: "img/theRock.png", offsetX: -75, offsetY: -60, sizeX: 0.5, sizeY: 0.5, speed: 3, damage: 10, points: 100},
          { type: "enemy", x: 1900, y: groundY - 50, image: "img/theRock.png", offsetX: -75, offsetY: -60, sizeX: 0.5, sizeY: 0.5, speed: 3, damage: 10, points: 100},
          { type: "enemy", x: 2500, y: groundY - 50, image: "img/theRock.png", offsetX: -75, offsetY: -60, sizeX: 0.5, sizeY: 0.5, speed: 3, damage: 10, points: 100},
          { type: "reward", x: 600, y: groundY - 110, hitZoneSize: 25, image: "img/coin.png", offsetX: -29, offsetY: -26, sizeX: 0.25, sizeY: 0.25, speed: 1, healthGained: 10, points: 100},
          { type: "reward", x: 1000, y: groundY - 110, hitZoneSize: 25, image: "img/coin.png", offsetX: -29, offsetY: -26, sizeX: 0.25, sizeY: 0.25, speed: 1, healthGained: 10, points: 100},
          { type: "reward", x: 1500, y: groundY - 110, hitZoneSize: 25, image: "img/coin.png", offsetX: -29, offsetY: -26, sizeX: 0.25, sizeY: 0.25, speed: 1, healthGained: 10, points: 100},
        ],
      },
    ];
